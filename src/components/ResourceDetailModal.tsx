  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-3xl font-bold text-white mb-6">{resource.title}</h2>
        <div className="prose prose-invert prose-sm sm:prose-base max-w-none prose-a:text-pink-400 hover:prose-a:text-pink-300 prose-strong:text-white">
